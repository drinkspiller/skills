...
Uses the vocabulary in language.md — **module**, **interface**, **seam**,
**adapter**, **leverage**.
...
details, dependency category from deepening.md, what sits behind the seam). Give
each agent a different design constraint:
