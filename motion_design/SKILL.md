...
> Deep dive: [core-philosophy.md](references/core-philosophy.md)
...
> Deep dive: [motion-personality.md](references/motion-personality.md)
...
> Deep dive: [property-selection.md](references/property-selection.md)
...
> Deep dive: [timing-easing-tables.md](references/timing-easing-tables.md)
...
> More patterns: [entrance-exit.md](references/entrance-exit.md) | [state-feedback.md](references/state-feedback.md)
...
> Deep dive: [choreography.md](references/choreography.md)
...
> Deep dive: [emotion-mapping.md](references/emotion-mapping.md)
...
> Full checklist: [quality-checklist.md](references/quality-checklist.md)
...
> Deep dive: [troubleshooting.md](references/troubleshooting.md)
...
- [core-philosophy.md](references/core-philosophy.md) — Three Pillars deep dive
- [decision-framework.md](references/decision-framework.md) — Full decision pipeline
- [disney-principles.md](references/disney-principles.md) — 12 principles, UI-adapted
- [motion-personality.md](references/motion-personality.md) — 4 archetypes + brand identity
- [emotion-mapping.md](references/emotion-mapping.md) — Emotion → motion + color psychology
- [choreography.md](references/choreography.md) — Multi-element coordination
- [narrative-structure.md](references/narrative-structure.md) — Micro-story framework
- [context-adaptation.md](references/context-adaptation.md) — Platform, a11y, performance

**Reference** (references/):
- [timing-easing-tables.md](references/timing-easing-tables.md) — Duration + easing lookups
- [property-selection.md](references/property-selection.md) — Property communication guide
- [troubleshooting.md](references/troubleshooting.md) — Animation smells + fixes
- [quality-checklist.md](references/quality-checklist.md) — Evaluation criteria

**Patterns** (references/):
- [entrance-exit.md](references/entrance-exit.md) — Entrance/exit recipes
- [state-feedback.md](references/state-feedback.md) — Success, error, loading, hover
- [ambient-continuous.md](references/ambient-continuous.md) — Looping, breathing, parallax
- [multi-element.md](references/multi-element.md) — Stagger + choreography recipes
