...
name: ux-copy
description: >
  Writes or reviews UX copy including microcopy, error messages, empty states,
  CTAs, tooltips, loading states, and onboarding text. Use when asked to "write
  copy for", "what should this button say?", "review this error message",
  "improve this CTA", "word this confirmation dialog", "fill this empty state",
  or "write onboarding text".
---
...
- Label buttons with the action: "Delete files" / "Keep files" not "OK" /
  "Cancel"
...
[Anything translators should know — idioms to avoid, character expansion,
cultural context]
```
...
- **Brand voice guidelines and content style guides** to match existing tone and
  terminology standards
- **Design mockups or Figma files** to understand screen context, character
  limits, and layout constraints

## Tips

1. **Be specific about context** — "Error message when payment fails" is better
   than "error message."
2. **Share your brand voice** — "We're professional but warm" helps match your
   tone.
